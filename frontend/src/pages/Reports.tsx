...
const Reports = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 dark:from-slate-900 dark:via-slate-800 dark:to-slate-950 -m-6 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-slate-800 shadow-sm rounded-2xl p-4 md:p-6 mb-4 md:mb-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-4 border-b-4 border-slate-700 dark:border-slate-600 animate-slideDown relative z-20">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Reports & Analytics</h2>
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 mt-1 font-medium">Track your meetings and tasks</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex gap-3 bg-white dark:bg-slate-800 rounded-2xl p-2 shadow-lg">
            <button
              onClick={() => setActiveTab('meetings')}
              className={`relative flex-1 px-8 py-4 rounded-xl text-base font-bold transition-all duration-300 ${activeTab === 'meetings'
                ? 'bg-gradient-to-r from-slate-900 to-slate-800 dark:from-slate-700 dark:to-slate-600 text-white shadow-lg'
